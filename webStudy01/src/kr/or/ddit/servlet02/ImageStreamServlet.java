...
//      String contentsPath = config.getInitParameter("contentsPath");
   ...
   protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
      ...
      String alreadyImages = utils.getCookieValue(Contants.IMAGESTREAMINCOOKIENAME);
      ...
      Cookie imageCookie = CookieUtils.createCookie(Contants.IMAGESTREAMINCOOKIENAME, json, TextType.PATH, req.getContextPath(), 3600*24*2);
//      Cookie imgCookie = new Cookie("imgCookie", json);
//      imgCookie.setPath(req.getContextPath());
//      imgCookie.setMaxAge(3600 * 24 * 2);
